...
# Connection string
username = "dev1user"
password = "dev1@emps@db"  # your actual password with @ symbols
host = "dev1epms.database.windows.net"
database = "ERISK-Copy-IGS"
encoded_password = urllib.parse.quote(password) # Encode the password properly
connection_url = f"mssql+pymssql://{username}:{encoded_password}@{host}/{database}" # Build the connection string
